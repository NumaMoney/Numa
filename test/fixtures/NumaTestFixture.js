...
async function deployPrinterTestFixtureArbi() {
  ...
  let { DEPLOY_UNISWAP, WETH_ADDRESS, FACTORY_ADDRESS,
    POSITION_MANAGER_ADDRESS, PRICEFEEDETHUSD,PRICEFEEDBTCETH, INTERVAL_SHORT, INTERVAL_LONG, FLEXFEETHRESHOLD, FEE } = configArbi;
  ...
  // DOES NOT WORK ON ARBI FORK BUT NOT NEEDED FOR NOW FOR VAULT TESTS. TODO: SHOULD BE FIXED!!!  
...
async function deployPrinterTestFixtureSepo() {
  ...
  let { DEPLOY_UNISWAP, WETH_ADDRESS, FACTORY_ADDRESS,
    POSITION_MANAGER_ADDRESS, PRICEFEEDETHUSD,PRICEFEEDBTCETH, INTERVAL_SHORT, INTERVAL_LONG, FLEXFEETHRESHOLD, FEE } = configSepo;
