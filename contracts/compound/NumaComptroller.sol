 ...
 * @author Compound
 */
contract NumaComptroller is ComptrollerV6Storage, ComptrollerInterface, ComptrollerErrorReporter, ExponentialNoError {
    ...
    function _become(Unitroller unitroller) public {
        ...
        NumaComptroller(address(unitroller))._upgradeSplitCompRewards();
    }
