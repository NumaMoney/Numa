...
//     function test_NumaBorrow_JRV4_liquidateBadDebtPartialLiquidation() public {
//         prepare_numaBorrow_JRV4();
//         // make it bad debt
//         // vm.roll(block.number + blocksPerYear/4);
//         // cNuma.accrueInterest();
...
//         // test repay half (partial liquidation)
//         vault.liquidateNumaBorrower(userA, (borrowBalance*0.5 ether) /1 ether, false, false);
